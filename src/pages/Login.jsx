                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className={`py-4 px-6 rounded-2xl border-2 font-bold transition-all duration-300 ${formData.role === "user"
                    ...
                    <button
                      ...
                      className={`py-4 px-6 rounded-2xl border-2 font-bold transition-all duration-300 ${formData.role === "admin"
                        ? "bg-emerald-600 text-white border-emerald-600 shadow-lg shadow-emerald-600/30"
                        : "bg-white text-gray-700 border-gray-200 hover:border-emerald-300"
                        }`}
                    >
