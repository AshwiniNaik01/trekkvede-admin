...
import { FaMountain, FaStar, FaFilter, FaSearch, FaHistory, FaCommentDots } from "react-icons/fa";
...
export default function ManageReviews() {
    ...
    const fetchData = async () => {
        try {
            ...
            if (Array.isArray(reviewsRes)) {
                ...
                const arrayKey = Object.keys(reviewsRes).find(key => Array.isArray(reviewsRes[key]));
            ...
            if (Array.isArray(treksRes)) {
                ...
                const arrayKey = Object.keys(treksRes).find(key => Array.isArray(treksRes[key]));
    ...
    const filteredReviews = Array.isArray(reviews) ? reviews.filter(review => {
        ...
        const trekIdVal = typeof review.trekId === 'object' ? review.trekId._id : review.trekId;
        const matchesTrek = selectedTrek === "all" || trekIdVal === selectedTrek;
        ...
        return matchesTrek && (reviewName.includes(search) || reviewDesc.includes(search));
    }) : [];
    ...
    return [
        {
            ...
            rating: 4.8,
            description: "My first and only trek ordered on Treekvede, and I'm beyond delighted! I requested a custom trail based on two summits I was called to invite together in this kind of creation.",
        ...
        },
        {
            ...
            rating: 5,
            description: "Absolutely breathtaking experience. The guides were professional and the view from the top was worth every drop of sweat.",
        ...
        },
        {
            ...
            rating: 3.5,
            description: "The trek was good but the food provided could have been better. Otherwise, the logistics were well managed.",
