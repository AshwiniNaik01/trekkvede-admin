...
//       setData(data.filter((b) => b._id !== row._id));
//     }
//   };
...
//           </span>
//         ) : (
//           <span className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 text-gray-400 rounded-xl border border-gray-100 text-[10px] font-black uppercase">
//             <FaClock /> Pending
//           </span>
//         ),
//     },
...
//               Track and manage trek reservations
//             </p>
//           </div>
//         </header>
...
//               <Info label="Customer" value={selectedBooking.name} />
