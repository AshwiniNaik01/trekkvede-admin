...
export default function DataTable({
  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl shadow-emerald-900/5 border border-emerald-50/50 overflow-hidden pb-8 pt-2">
      {/* Header Actions */}
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-emerald-50/20">
              ...
              {rowActions.length > 0 && (
                <th className="px-6 py-4 border-b border-emerald-50 w-20"></th>
              )}
            </tr>
          </thead>
